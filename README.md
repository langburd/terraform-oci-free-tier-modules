...
Each module under `modules/` gets its own semver tag (e.g., `modules/budget/v1.2.0`) and GitHub Release. Version bumps follow [Conventional Commits](https://www.conventionalcommits.org/):
