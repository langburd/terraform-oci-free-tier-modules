...
| <a name="input_create_attachment"></a> [create\_attachment](#input\_create\_attachment) | (Optional) Whether to create a volume attachment to the instance specified by instance\_id. Must be false when instance\_id is null. | `bool` | `false` | no |
