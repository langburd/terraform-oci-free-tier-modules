...
| Name | Type |
|------|------|
| [ansible_playbook.k3s_deploy](https://registry.terraform.io/providers/ansible/ansible/latest/docs/resources/playbook) | resource |
...
| <a name="input_ssh_user"></a> [ssh\_user](#input\_ssh\_user) | SSH username to connect to K3s nodes. | `string` | `"ubuntu"` | no |
