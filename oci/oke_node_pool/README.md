...
| <a name="input_node_shape"></a> [node\_shape](#input\_node\_shape) | Shape of each node. Only Flex and Micro free-tier shapes are supported. | `string` | `"VM.Standard.A1.Flex"` | no |
